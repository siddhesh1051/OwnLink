                        ...
                        <div className="grid grid-cols-8 gap-6 md:gap-0">
                            <div className="col-span-8 border-r border-gray-100 dark:border-gray-800 md:col-span-2 lg:col-span-3">
                                ...
                                >
                                    ...
                                    <div className="flex gap-6">
                                        ...
                                        <a href="https://github.com/siddhesh1051/OwnLink" target="blank" aria-label="twitter" className="hover:text-purple-600">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="20"
                                                height="20"
                                        ...
                                        <a href="https://github.com/siddhesh1051/OwnLink" target="blank" aria-label="medium" className="hover:text-purple-600">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="20"
                                                height="20"
                            ...
                            <div className="col-span-8 md:col-span-6 lg:col-span-5">
                                ...
                                <div className="flex justify-between border-t border-gray-100 dark:border-gray-800 py-4 pb-8 md:pl-16">
                                    <span>&copy; Ownlink 2023 <span id="year"></span> </span>
