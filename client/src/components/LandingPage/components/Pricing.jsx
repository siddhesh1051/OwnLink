      ...
      <div className="xl:container m-auto px-6 py-20 md:px-12 lg:px-20">
        ...
        <div className="mt-12 grid items-center gap-6 md:grid-cols-2 lg:flex lg:space-x-8">
          <div className="group relative md:col-span-1 lg:w-[32%]">
            <div
              aria-hidden="true"
              className="absolute top-0 h-full w-full rounded-3xl border border-gray-700 bg-gray-800 shadow-2xl shadow-none transition duration-500 group-hover:scale-105 lg:group-hover:scale-110"
            />
            <div className="relative space-y-8 p-8">
              ...
              <ul
                role="list"
                className="m-auto w-max space-y-4 pb-6 text-gray-300"
              >
              ...
              <button
                className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primaryLight before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95"
          ...
          <div className="group relative row-start-1 md:col-span-2 lg:w-[36%]">
            <div
              aria-hidden="true"
              className="absolute top-0 h-full w-full rounded-3xl border border-gray-700 bg-gray-800  shadow-none transition duration-500 group-hover:scale-105 lg:group-hover:scale-110"
            />
            <div className="relative space-y-8 p-8">
              <h3 className="text-center text-3xl font-semibold text-white">
                Annual
              ...
              <div className="overflow-hidden">
                ...
                <div className="text-center text-2xl font-medium">
                  ...
                  <span className="font-semibold text-white ml-2">$190</span>
                </div>
          ...
          <div className="group relative md:col-span-1 lg:w-[32%]">
            ...
            <div className="relative space-y-8 p-8">
              ...
              <button
                className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full  before:border-gray-600 before:bg-gray-700 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95"
                onClick={() => navigate("/routes/auth")}
              >
                <span className="relative text-base font-semibold text-white">
                  Get Started
