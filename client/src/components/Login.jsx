          ...
          }
          {
            isLoading
              ...
              <motion.button
                ...
                variant='solid' type='button' onClick={() => { onLogin(values) }} className='bg-[#6D42B9] hover:bg-[#5c369f] active:scale-95 text-white text-lg  w-[90%] lg:w-[70%] h-12 rounded-lg mx-8 mt-2 duration-300'><Spinner />
                </motion.button>
              :
              <motion.button
                initial={{ opacity: 0 }}
                ...
                variant='solid' type='button' onClick={() => { onLogin(values) }} className='bg-[#6D42B9] hover:bg-[#5c369f] active:scale-95 text-white text-lg  w-[90%] lg:w-[70%] h-12 rounded-lg mx-8 mt-2 duration-300'>Log in
                </motion.button>
