  ...
  return (
    ...
    >
      ...
      <Menu
        ...
        variant="plain"
      >
        <MenuItem sx={{ fontSize: "16px" }}>{email}</MenuItem>
        <MenuItem
          onClick={() => {
            username !== null
              ? handleQrOpen()
        ...
        <MenuItem onClick={logOut} sx={{ fontSize: "16px", color: "red" }}>
          Logout{" "}
          <LuLogOut className="inline lg:text-md text-sm ml-2 text-red-500" />
        </MenuItem>
      </Menu>
    </div>
  );
